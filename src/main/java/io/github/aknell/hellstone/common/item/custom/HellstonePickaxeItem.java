...
public class HellstonePickaxeItem extends PickaxeItem {
	...
	public HellstonePickaxeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
	...
	public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
		...
		if(stack.getItem() == HellstoneItems.HELLSTONE_PICKAXE) target.setOnFireFor(30);
		return true;
	}
}
